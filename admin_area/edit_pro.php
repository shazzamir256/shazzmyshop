...
<td>
<input type="text" name="product_title" size="50" value="<?php echo $p_title; ?>"/>
</td>
</tr>
...
<tr>
<td align="center"><b>Product Image2</b>
</td>
...
<td>
<input type="text" name="product_keywords" size="50" value="<?php echo $p_desc;  ?>"/>
</td>
</tr>
...
if(isset($_POST['update_product'])){
  ...
  $update_product = "UPDATE products SET cat_id='$product_cat',brand_id='$product_brand',date=NOW(),
					  ...
					  WHERE product_id='$update_id'";                                                                                /* $update_id means update specific id ,not all id*/
